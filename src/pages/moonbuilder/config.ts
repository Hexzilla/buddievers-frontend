...
export const groupUrls_: StringObject = {
  bodies: 'resources/bodies/',
  tops: 'resources/tops/',
  pants: 'resources/pants/',
  suits: 'resources/suits/',
  hair: 'resources/hair/',
...
const transcended_: StringObject = {
  Astronaut: 'astronaut.glb',
  Ape: 'ape.glb',
  'Plague Doctor': 'plague_doctor.glb',
  Samurai: 'samurai.glb',
...
export const traits_: { [key: string]: StringObject } = {
  bodies: bodies_,
  tops: tops_,
  pants: pants_,
  suits: suits_,
