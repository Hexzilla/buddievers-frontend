...
const Seeds = () => {
    ...
    const {container, overViewItem, btnBuy, btnOffer, tradeButtons, tradeButton, tableBtn, tradeTable, tableWrapper } = useClasses(styles);
    function createData(
        ID: string,
        Price: string,
        Endsin: string,
            ...
            <div className={container}>
                <Grid container spacing={4}>
                    <Grid item md={4} sm={12}>
                        <img src={`./B-BUDS3.png`} style={{ maxWidth : "100%", height : "100%", borderRadius : "20px" }} />
                    </Grid>
                    <Grid item md={8} sm={12}>
                        ...
                        <div>
                            <Grid container spacing={2}>
                                <Grid item md={4} sm={12} style={{ textAlign : "left", marginTop : "20px" }}>
                                    <p style={{ fontSize : "24px", color : "rgba(255, 255, 255, 0.5)", margin : 0 }}>BUDDIEVERSE</p>
                                    <p style={{ fontSize : "38px", color : "white", fontWeight : "900", margin : 0 }}>$SEEDS</p>
                                </Grid>
                                <Grid item md={4} sm={12} style={{ textAlign : "right", marginTop : "20px" }}>
                                    <p style={{ fontSize : "24px", color : "#00CE4C", margin : 0 }}>PRICE</p>
                                    <p style={{ fontSize : "38px", color : "white", fontWeight : "900", margin : 0 }}>1 SAMA</p>
                                </Grid>
                                <Grid item md={4} sm={12} style={{ textAlign : "right", marginTop : "20px" }}>
                                    <p style={{ fontSize : "24px", color : "#00CE4C", margin : 0 }}>PRICE</p>
                                    <p style={{ fontSize : "38px", color : "white", fontWeight : "900", margin : 0 }}>0.024 USDT</p>
                                </Grid>
                            </Grid>
                        </div>
                        <div style={{ color : "white", marginTop : "20px" }}>
                            <p style={{ fontSize : "24px" }}><span style={{ color : "#00CE4C" }}>YOUR BALANCE</span>&nbsp;&nbsp;&nbsp; 100 000$SEEDS</p>
                        </div>
